...
export default function RafflePage() {
    ...
    const { postData, raffles, newprices, loading, isSuccess, recordsTotal } =
    ...
    useEffect(() => {
        ...
        dispatch(getRafflesAdmin(postData))
    ...
    const handleChangePage = (event, newPages) => {
        ...
        let newPostdata = { ...postData, currentPage: newPages }
        ...
        if (recordsTotal == recordsTotal) {
            ...
            dispatch(setParams(newPostdata));
            dispatch(getRafflesAdmin(newPostdata))
            return;
        } else {
        }
