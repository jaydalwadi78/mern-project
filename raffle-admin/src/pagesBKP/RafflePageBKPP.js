...
export default function RafflePage() {
    ...
    const { postData, raffles, newprices, loading, isSuccess, recordsTotal, currentPage } =
    ...
    const handleChangePage = (event) => {
        ...
        let newPostdata = { ...postData, currentPage: newPage }



        console.log("newPage>>>jay", newPage);
        console.log("newPostdata>>>jay", newPostdata);
