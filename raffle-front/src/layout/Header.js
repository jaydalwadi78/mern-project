...
const Header = () => {
    ...
    useEffect(() => {
        if (isForgotPassword === true) {
            openNotification(
                "success",
                "We have send mail for reset password!"
            );
            forgot(false);
            dispatch(clearMessage());
        }
        ...
        <>
            <Container>
                ...
                <Row>
                    <Col
                        md="12"
                        className="d-flex justify-content-between align-items-center flex-sm-row flex-column"
                    >
                        <div className="logo">
                            <NavLink to={"/"}>
                                <img
                                    src={require("../assets/imgs/raffle_logo.png")}
                                    alt="Raffle"
                                />
                            </NavLink>
                        </div>
                            ...
                            <ul>
                                ...
                                <li className="tiwtter_btn">
                                    <NavLink
                                        target={"_blank"}
                                        to={
                                            "https://twitter.com/upcomingraffle"
                                        }
                                    >
                                        <FaTwitter />
                                    </NavLink>
            ...
            >
                <h2>Register</h2>
                <p>
                    Fill out all the details to register and create a raffle
                    account here.
                </p>
                <Form
                    name="basic"
